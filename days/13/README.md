...
## Task
* _part1_: Get the minimal value of movements that satisfies the price value ie. do some A and some B movements, add the values together and if those match the prize values then then the combination is valid, the value of this combination is tree times the A buttons pressed and one times the B button pressed added together.
