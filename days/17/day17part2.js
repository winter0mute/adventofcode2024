...
// let fileAregister=Number(data[0].split(' ')[2]);
let fileBregister=Number(data[1].split(' ')[2]);
let fileCregister=Number(data[2].split(' ')[2]);
let fileProgram=data[4].split(' ')[1].split(',').map(Number);
...
while (! found) {
    let output=[];
    Aregister=forAregister;
    Bregister=fileBregister;
    Cregister=fileCregister;
    program=fileProgram;
    instructionPointer=0;
    if (forAregister%10000000==0){
        console.log('forAregister: '+forAregister);
    }
    ...
    while (instructionPointer<program.length) {
        ...
        // console.log('Cregister: '+Cregister);
